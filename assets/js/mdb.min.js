							...
							function r() {
								function t(t) {
									...
									function m() {
										...
										if (o && n)
											...
											v.init(c),
												...
												u.each(["overflow", "overflowX", "overflowY"], function(
													t,
													e
												) {
									...
									if ("scroll" === T) {
										...
										c.container
											? p.isWrapped(c.container) || p.isNode(c.container)
												? ((c.container = c.container[0] || c.container),
												  (M =
														(x = c.container["scroll" + I]) +
														u(r).position()[I.toLowerCase()] +
														A))
												: (c.container = null)
											: ((x =
													v.State.scrollAnchor[v.State["scrollProperty" + I]]),
											  (k =
													v.State.scrollAnchor[
														v.State[
															"scrollProperty" + ("Left" === I ? "Top" : "Left")
														]
													]),
											  (M = u(r).offset()[I.toLowerCase()] + A)),
											(d = {
												scroll: {
													rootPropertyValue: !1,
													startValue: x,
										...
										y)) {
											...
											if (
												a(r).isSVG ||
												"tween" === z ||
												!1 !== b.Names.prefixCheck(z)[1] ||
												b.Normalizations.registered[z] !== n
											) {
												((c.display !== n &&
													null !== c.display &&
													"none" !== c.display) ||
													...
													c._cacheValues && O && O[E]
														? (W === n && (W = O[E].endValue + O[E].unitType),
														  (N = a(r).rootPropertyValueCache[z]))
														: b.Hooks.registered[E]
														? W === n
															? ((N = b.getPropertyValue(r, z)),
															  (W = b.getPropertyValue(r, E, N)))
															: (N = b.Hooks.templates[z][1])
														: W === n && (W = b.getPropertyValue(r, E));
												var H,
													B,
													j,
													Y = !1;
									...
									d.element &&
										...
										(a(r).isAnimating = !0),
										S === C - 1
											? (v.State.calls.push([R, g, c, null, P.resolver]),
											  !1 === v.State.isTicking &&
								...
								switch (
																...
																n === o &&
																	...
																	"stop" === y
																		? (a(n) &&
																				a(n).tweensContainer &&
																				!1 !== r &&
																				u.each(a(n).tweensContainer, function(
																					t,
																					e
																				) {
									...
									default:
										if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
											...
											return (
												P.promise ? P.rejecter(new Error(_)) : console.log(_),
												t()
											);
										}
										T = "start";
							...
							legend: {
								...
								onClick: function(t, e) {
									var i,
										...
										r = this.chart;
									for (i = 0, n = (r.data.datasets || []).length; i < n; ++i)
										(o = r.getDatasetMeta(i)).data[a].hidden = !o.data[a]
											.hidden;
									r.update();
								}
							},
								...
								draw: function(t) {
									...
									if (i.display) {
										var o = e.ctx,
											...
											O =
												"bottom" === i.position ? e.top + P : e.bottom - w - P,
											_ =
												"bottom" === i.position ? e.top + P + w : e.bottom + P;
										if (
											...
											if (m)
												...
												(D = F ? e.left + R + S.top : e.right - R - S.top),
										...
										if (h.drawBorder) {
											...
											m
												? ((W = z = "top" === i.position ? e.bottom : e.top),
												  (W += N),
												  (z += N))
												: (($ = V = "left" === i.position ? e.right : e.left),
												  ($ += N),
												  (V += N)),
												o.beginPath(),
												o.moveTo($, W),
					...
					_createClass(d, [
							...
							value: function(t) {
								if ("left" === this.options.edge) {
									...
									(this.menuOut = e),
										this.$menu.css(
											"transform",
											"translateX(".concat(t - this.options.menuWidth, "px)")
										);
								} else {
						...
						},
						{
							...
							value: function(t) {
								...
								(e =
									"left" === this.options.edge
										? t / this.options.menuWidth
										: Math.abs(
												(t - window.innerWidth) / this.options.menuWidth
										  )),
						...
						},
						{
							...
							value: function() {
								...
								this.options.menuWidth !== e &&
									(this.$menu.css("width", this.options.menuWidth),
									i.css("width", this.options.menuWidth));
							}
						},
						{
							key: "assignOptions",
										...
										},
										{
											...
											complete: function() {
												!0 === t &&
													...
													e.$menu.css("width", e.options.menuWidth));
											}
										}
									),
									this.hideSidenavOverlay();
						...
						[
							{
								...
								value: function() {
									if (
										...
										var t = this.$materialSelectInitialOption.replace(
											/"/g,
											"&quot;"
										);
							...
							},
							{
								...
								value: function(e, i) {
									var n = e.is(":disabled") ? "disabled" : "",
										...
										a = e.data("icon"),
										r = e.data("fas")
											? '<i class="fas fa-'.concat(e.data("fas"), '"></i> ')
											: "",
										s = e.attr("class"),
										l = a
											? '<img alt="" src="'
									...
									this.$materialOptionsList.append(
										t(
											'<li class="'
												.concat(n, " ")
												.concat(o, '">')
												.concat(l, '<span class="filtrable">')
												.concat(c)
												.concat(r)
												.concat(e.html(), "</span></li>")
										)
									);
								}
							},
								...
								value: function() {
									...
									n.observe(this.$nativeSelect.get(0), {
										...
										this.$nativeSelect
											.parent()
											.find("button.btn-save")
											.on("click", this._onSaveSelectBtnClick),
										this.$materialSelect.on(
											"focus",
											this.debounce(this._onMaterialSelectFocus.bind(this), 300)
										),
										this.$materialSelect.on(
											"click",
							...
							},
							{
								...
								value: function(e, i, n) {
									...
									if (!o.hasClass("disabled") && !o.hasClass("optgroup")) {
										var a = !0;
										if (this.isMultiple) {
											o.find('input[type="checkbox"]').prop("checked", function(
												t,
												e
											) {
												return !e;
							...
							},
							{
								...
								value: function(e) {
									t(e.target).closest("#select-options-".concat(this.uuid))
										.length || this.$materialSelect.trigger("close");
								}
							},
							{
							...
							},
							{
								...
								value: function() {
									for (
										var t = "", e = this.valuesSelected.length, i = 0;
										i < e;
										i++
									) {
										var n = this.$nativeSelect
											.find("option")
						...
						"mousedown click": function(e) {
							...
							i != y.$holder[0] &&
								...
								"mousedown" != e.type ||
									...
									(e.preventDefault(), y.$holder[0].focus()));
						}
					})
					.on(
						"click",
			...
			(o.prototype.measure = function(t, e) {
				return (
					e
						? "string" == typeof e
							? (e = this.parse(t, e))
							: n.isInteger(e) && (e = this.now(t, e, { rel: e }))
						: (e = "min" == t ? -1 / 0 : 1 / 0),
					e
				);
			}),
			...
			(o.prototype.isDateExact = function(t, i) {
				return (n.isInteger(t) && n.isInteger(i)) ||
					...
					: !(!e.isPlainObject(t) || !e.isPlainObject(i)) &&
					  this.isDateExact(t.from, i.from) && this.isDateExact(t.to, i.to);
			}),
			...
			if (e.twelvehour)
				for (E = 0; E < 12; E += e.hourstep)
					(L = $.clone()),
						...
						L.css("font-size", "140%"),
						L.css({
							left: y + Math.sin(R) * F - w,
							top: y - Math.cos(R) * F - w
						}),
						L.html(0 === E ? 12 : E),
						p.append(L),
						L.on(u, z);
	...
	(function(t, e) {
		...
		return function(t, e, i, n) {
			...
			var s,
				...
				qt = function(t) {
					jt[t] && Xt(t), jt[t] || (Yt++, (jt[t] = {}));
				},
				Ut = function() {
					for (var t in jt) jt.hasOwnProperty(t) && Xt(t);
				},
				...
				Kt = {
					...
					updateSize: function(e) {
						...
						if (
							...
							for (var n, s, l, c = 0; 3 > c; c++)
								(n = k[c]),
									...
									(l = u + c - 1),
									r.loop && ze() > 2 && (l = wt(l)),
									(s = We(l)) && (w || s.needsUpdate || !s.bounds)
										? (a.cleanSlide(s),
										  a.setContent(n, l),
						...
						(v = g = a.currItem.initialZoomLevel),
							(J = a.currItem.bounds) &&
								((ut.x = J.center.x), (ut.y = J.center.y), It(!0)),
							St("resize");
					},
						...
						if (0 !== t)
							if (
								...
								if (
									...
									return;
								Et(Gt, K[1]), X || ((X = !0), St("zoomGestureStarted"));
								var e = he(Zt, Gt),
									i = Ee(e);
								i >
				...
				Ae = function(t) {
					...
					if (
						...
						if ((Ut(), z || (z = Oe()), z.calculateSwipeSpeed("x"), H))
							...
							if (!et)
								return "swipe" !== n
									? void Le()
									: void (!Q && g > a.currItem.fitRatio && _e(z));
						}
				},
				Oe = function() {
					var t,
				...
				publicMethods: {
					...
					setContent: function(t, e) {
						...
						if (l) {
							...
							$e || e !== u ? At(l) : ((tt = c.style), Ne(l, n || l.img)),
								(t.el.innerHTML = ""),
								t.el.appendChild(c);
						} else t.el.innerHTML = "";
					},
								...
								return (
									r.modal &&
										(!r.closeOnScroll || Yt || j
											? t.preventDefault()
											: I && Math.abs(t.deltaY) > 2 && ((c = !0), a.close())),
									!0
								);
					...
					k && t.currItem
						? (x.updateIndexIndicator(),
						  g.captionEl &&
								...
								P(o, "caption--empty", !t.currItem.title)),
						  (w = !0))
						: (w = !1),
						C || O(),
						I();
			...
			4: [
				function(t, e, i) {
					...
					(o.prototype.eventElement = function(t) {
						...
						return (
							void 0 === e && ((e = new n(t)), this.eventElements.push(e)), e
						);
					}),
						...
						!(function(t, e) {
							...
							e.event.bind(e.scrollbarY, "click", n),
								e.event.bind(e.scrollbarYRail, "click", function(n) {
									var r =
										n.pageY - window.pageYOffset - i(e.scrollbarYRail).top >
										e.scrollbarYTop
											? 1
											: -1;
								...
								e.event.bind(e.scrollbarXRail, "click", function(n) {
									var r =
										n.pageX - window.pageXOffset - i(e.scrollbarXRail).left >
										e.scrollbarXLeft
											? 1
											: -1;
									...
									l(t, "top", t.scrollTop - d),
										...
										(function(i, n) {
											...
											if (0 === n) {
												...
												if (
													(0 === a && i < 0) ||
													(a >= e.contentWidth - e.containerWidth && i > 0)
												)
													return !e.settings.wheelPropagation;
											}
											return !0;
								...
								e.settings.useBothWheelAxes
									? e.scrollbarYActive && !e.scrollbarXActive
										...
										: e.scrollbarXActive &&
										  ...
										  (n = !0))
									: (r(t, "top", t.scrollTop - l * e.settings.wheelSpeed),
							...
							e.event.bind(window, "mousemove", function(e) {
								if (u) {
									...
									a.x < r.left + 3
										...
										: (c.left = 0),
										a.y < r.top + 3
											? ((c.top = r.top + 3 - a.y < 5 ? -5 : -20),
											  o.startScrolling(t, "y"))
											: a.y > r.bottom - 3
											? ((c.top = a.y - r.bottom + 3 < 5 ? 5 : 20),
											  o.startScrolling(t, "y"))
											: (c.top = 0),
							...
							(function(t, e, i, n) {
								function s(i, n) {
									...
									if (s > r) {
										...
										r > s &&
										((i < 0 && a === e.contentWidth - e.containerWidth) ||
											(i > 0 && 0 === a))
									)
										return !e.settings.swipePropagation;
									return !0;
								...
								function f(t) {
									if (
										...
										var r = new Date().getTime(),
											c = r - v;
										c > 0 && ((y.x = o / c), (y.y = a / c), (v = r)),
											s(o, a) && (t.stopPropagation(), t.preventDefault());
									}
								}
								function m() {
									!x &&
						...
						return (
							...
							(u[e] = new (function(t) {
								...
								(n.settings = o.clone(r)),
									...
									(n.scrollbarXRail = s.appendTo(
										s.e("div", "ps__scrollbar-x-rail"),
										t
									)),
									(n.scrollbarX = s.appendTo(
										s.e("div", "ps__scrollbar-x"),
										n.scrollbarXRail
									)),
									...
									(n.scrollbarXBottom = o.toInt(
										s.css(n.scrollbarXRail, "bottom")
									)),
									(n.isScrollbarXUsingBottom =
										n.scrollbarXBottom == n.scrollbarXBottom),
									(n.scrollbarXTop = n.isScrollbarXUsingBottom
										? null
										: o.toInt(s.css(n.scrollbarXRail, "top"))),
									(n.railBorderXWidth =
										o.toInt(s.css(n.scrollbarXRail, "borderLeftWidth")) +
										o.toInt(s.css(n.scrollbarXRail, "borderRightWidth"))),
									s.css(n.scrollbarXRail, "display", "block"),
									(n.railXMarginWidth =
										o.toInt(s.css(n.scrollbarXRail, "marginLeft")) +
										o.toInt(s.css(n.scrollbarXRail, "marginRight"))),
									s.css(n.scrollbarXRail, "display", ""),
									(n.railXWidth = null),
									(n.railXRatio = null),
									(n.scrollbarYRail = s.appendTo(
										s.e("div", "ps__scrollbar-y-rail"),
										t
									)),
									(n.scrollbarY = s.appendTo(
										s.e("div", "ps__scrollbar-y"),
										n.scrollbarYRail
									)),
									...
									(n.scrollbarYRight = o.toInt(
										s.css(n.scrollbarYRail, "right")
									)),
									(n.isScrollbarYUsingRight =
										n.scrollbarYRight == n.scrollbarYRight),
									(n.scrollbarYLeft = n.isScrollbarYUsingRight
										? null
										: o.toInt(s.css(n.scrollbarYRail, "left"))),
									(n.scrollbarYOuterWidth = n.isRtl
										? o.outerWidth(n.scrollbarY)
										: null),
									(n.railBorderYWidth =
										o.toInt(s.css(n.scrollbarYRail, "borderTopWidth")) +
										o.toInt(s.css(n.scrollbarYRail, "borderBottomWidth"))),
									s.css(n.scrollbarYRail, "display", "block"),
									(n.railYMarginHeight =
										o.toInt(s.css(n.scrollbarYRail, "marginTop")) +
										o.toInt(s.css(n.scrollbarYRail, "marginBottom"))),
					...
					e.exports = function(t) {
						...
						(i.containerWidth = t.clientWidth),
							...
							t.contains(i.scrollbarXRail) ||
								((e = r.queryChildren(t, ".ps__scrollbar-x-rail")).length > 0 &&
									e.forEach(function(t) {
										r.remove(t);
									}),
								r.appendTo(i.scrollbarXRail, t)),
							t.contains(i.scrollbarYRail) ||
								((e = r.queryChildren(t, ".ps__scrollbar-y-rail")).length > 0 &&
									e.forEach(function(t) {
										r.remove(t);
									}),
							...
							i.containerWidth + i.settings.scrollXMarginOffset < i.contentWidth
								? ((i.scrollbarXActive = !0),
								  ...
								  (i.scrollbarXWidth = n(
										i,
										o.toInt((i.railXWidth * i.containerWidth) / i.contentWidth)
								  )),
								  (i.scrollbarXLeft = o.toInt(
			...
			20: [
				function(t, e, i) {
					...
					e.exports = function(t, e, i) {
						...
						var a = n.get(t);
						"top" === e &&
							i >= a.contentHeight - a.containerHeight &&
							((i = a.contentHeight - a.containerHeight) - t.scrollTop <= 1
								? (i = t.scrollTop)
								: (t.scrollTop = i),
							t.dispatchEvent(o("ps-y-reach-end"))),
							"left" === e &&
								i >= a.contentWidth - a.containerWidth &&
								((i = a.contentWidth - a.containerWidth) - t.scrollLeft <= 1
									? (i = t.scrollLeft)
									: (t.scrollLeft = i),
							...
							"top" === e &&
								i !== a.lastTop &&
								((t.scrollTop = a.lastTop = i),
								t.dispatchEvent(o("ps-scroll-y"))),
							"left" === e &&
								i !== a.lastLeft &&
								((t.scrollLeft = a.lastLeft = i),
	...
	(function(t) {
		t(".input-default-wrapper").on("change", ".input-default-js", function(e) {
			var i = t(e.target),
				...
				a = "";
			o && o.length > 1
				? (a = (i.attr("data-multiple-target") || "").replace(
						"{target}",
						o.length
				  ))
				: e.target.value && (a = e.target.value.split("\\").pop()),
				a ? n.find(".span-choose-file").html(a) : n.html(n.html());
		});
	})(jQuery);
