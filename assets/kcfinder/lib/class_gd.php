...
class gd
{
	...
	public function imagecopy(
		...
		if ($image_details !== false) {
			...
			if (null === $dst_w) $dst_w = $this->width - $dst_x;
			if (null === $dst_h) $dst_h = $this->height - $dst_y;
			if (null === $src_w) $src_w = $src_width - $src_x;
			if (null === $src_h) $src_h = $src_height - $src_y;
